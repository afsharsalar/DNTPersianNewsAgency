...
using DNTPersianNewsAgency.Core.FeedReaders.Parser;
using DNTPersianNewsAgency.Core.FeedReaders.Parser.Exceptions;

namespace DNTPersianNewsAgency.Core.FeedReaders
{
    /// <summary>
